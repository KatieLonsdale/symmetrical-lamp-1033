def test_data
  @supermarket_1 = Supermarket.create!(name: 'King Soopers', location: 'Littleton')
  @supermarket_2 = Supermarket.create!(name: 'Safeway', location: 'Denver')
  @supermarket_3 = Supermarket.create!(name: 'Sprouts', location: 'Golden')
  @item_1 = @supermarket_1.items.create!(name: 'bananas', price: 2)
  @item_2 = @supermarket_1.items.create!(name: 'bread', price: 3)
